...
- [Vue d'ensemble de la plateforme](plateforme/doctrine.md)
- [Architecture](architecture/hierarchie.md)
- [Démarrage](operations/demarrage.md)
- [Composants](plateforme/composants.md)
- [Conformité](../en/compliance/stir-shaken.md)
...
- [Platform Overview](../en/platform/doctrine.md)
- [Architecture](../en/architecture/hierarchy.md)
- [Getting Started](../en/operations/getting-started.md)
- [Components](../en/platform/components.md)
- [Compliance](../en/compliance/stir-shaken.md)
...
## Composantes de la plateforme / Platform Components

<div class="component-grid" markdown="1">

- **🧠 Souverix Coeur** — Noyau IMS / IMS Core
- **🛡 Souverix Rempart** — SIG-GW / IBCF
- **🎛 Souverix Relais** — Plan média / Media Plane
- **🔐 Souverix Autorite** — PKI / HSM / Vault
- **👁 Souverix Vigie** — Intelligence IA / AI Intelligence
- **🎯 Souverix Mandat** — Interception légale / Lawful Intercept
- **🚨 Souverix Priorite** — Services d'urgence / Emergency Services
- **📊 Souverix Vigile** — Observabilité / Observability
- **🌐 Souverix Federation** — Contrôle inter-domaines / Inter-domain Control
- **⚙ Souverix Gouverne** — Plan de contrôle / Policy Control Plane

</div>

---

## Structure de la documentation / Documentation Structure
...
## Parcours de lecture suggéré / Suggested Reading Path

1. **Plateforme → Vue d'ensemble / Composants / Nomenclature** / **Platform → Overview / Components / Naming**
2. **Architecture → Couches / CNF OpenShift** / **Architecture → Layers / OpenShift CNF**
3. **Conformité → STIR/SHAKEN / Interception légale / Urgence** / **Compliance → STIR/SHAKEN / Lawful Intercept / Emergency**

---

## Énoncé de doctrine / Doctrine Statement
...
Conçu au Canada. Construit pour le contrôle souverain. / Designed in Canada. Built for sovereign control.
