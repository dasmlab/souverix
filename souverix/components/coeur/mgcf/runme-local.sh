...
# runme-local.sh - Run mgcf component container locally
...
PORT="${PORT:-8085}"                    # Main server
METRICS_PORT="${METRICS_PORT:-9095}"    # Prometheus metrics
DIAG_PORT="${DIAG_PORT:-9085}"              # Diagnostics
TEST_PORT="${TEST_PORT:-9185}"              # Test endpoints
