...
# runme-local.sh - Run scscf component container locally
...
PORT="${PORT:-8083}"                    # Main server
METRICS_PORT="${METRICS_PORT:-9093}"    # Prometheus metrics
DIAG_PORT="${DIAG_PORT:-9083}"              # Diagnostics
TEST_PORT="${TEST_PORT:-9183}"              # Test endpoints
