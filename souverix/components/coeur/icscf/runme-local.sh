...
PORT="${PORT:-8082}"                    # Main server
METRICS_PORT="${METRICS_PORT:-9092}"    # Prometheus metrics
DIAG_PORT="${DIAG_PORT:-9082}"              # Diagnostics
TEST_PORT="${TEST_PORT:-9182}"              # Test endpoints
